...
const routes = [
    ...
    { path: 'dashboard', component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_7__["DashboardComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_9__["AuthGuard"]] },
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [_services_validate_service__WEBPACK_IMPORTED_MODULE_13__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_14__["AuthService"], angular2_flash_messages__WEBPACK_IMPORTED_MODULE_15__["FlashMessagesService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AuthGuard"]],
...
let RegisterComponent = class RegisterComponent {
    ...
    onRegisterSubmit() {
        ...
        this.authService.registerUser(user).subscribe(data => {
            if (data.success) {
                this.flashMessage.show('사용자 등록 성공', { cssClass: 'alert-success', timeout: 3000 });
                this.router.navigate(['/login']);
            }
            else {
...
module.exports = __webpack_require__(/*! F:\node2019\meanauthapp\angular-src\src\main.ts */"./src/main.ts");
